...
{
    using CommonValueConverters.Helper;
    using System;
    ...
    public class MapConverter : IValueConverter
    {
        ...
        public FallbackBehavior FallbackBehavior
        {
            ...
            set
            {
                ArgumentHelper.AssertEnumMember(value, "value", FallbackBehavior.ReturnFallbackValue, FallbackBehavior.ReturnOriginalValue, FallbackBehavior.ReturnUnsetValue);
